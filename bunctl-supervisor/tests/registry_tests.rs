...
fn test_registry_list() {
    ...
    registry.register(app1.clone(), ProcessHandle {
        pid: 100,
        app_id: app1.clone(),
        inner: None,
    });
    
    registry.register(app2.clone(), ProcessHandle {
        pid: 200,
        app_id: app2.clone(),
        inner: None,
    });
    
    registry.register(app3.clone(), ProcessHandle {
        pid: 300,
        app_id: app3.clone(),
        inner: None,
    });
...
fn test_registry_concurrent_access() {
    ...
    for i in 0..10 {
        ...
        let handle = thread::spawn(move || {
            ...
            registry_clone.register(app_id.clone(), ProcessHandle {
                pid: i as u32,
                app_id,
                inner: None,
            });
...
fn test_registry_overwrite() {
    ...
    registry.register(app_id.clone(), ProcessHandle {
        pid: 1111,
        app_id: app_id.clone(),
        inner: None,
    });
